...
public class PlantWateringService extends IntentService {
    ...
    private void handleActionWaterPlant(long plantId) {
        ...
        // Update only if plant is still alive
        getContentResolver().update(
                SINGLE_PLANT_URI,
                contentValues,
                PlantContract.PlantEntry.COLUMN_LAST_WATERED_TIME + ">?",
                new String[]{String.valueOf(timeNow - PlantUtils.MAX_AGE_WITHOUT_WATER)});
        // force update after watering
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            shouldWater = (timeNow - wateredAt) > PlantUtils.MIN_AGE_BETWEEN_WATER &&
        ...
        PlantWidgetProvider.updatePlantWidgets(this, appWidgetManager, imgRes, appWidgetIds, plantId, shouldWater);
    }
}
